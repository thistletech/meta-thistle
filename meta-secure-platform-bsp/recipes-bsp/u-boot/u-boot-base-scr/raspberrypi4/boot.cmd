...
setenv boot_cmd_a "setenv bootargs ${base_bootargs} root=/dev/mmcblk0p2 rootfstype=ext4 rootwait; ext4load mmc 0:2 ${fit_addr} /boot/fitImage; bootm ${fit_addr} - ${fdt_addr}"
setenv boot_cmd_b "setenv bootargs ${base_bootargs} root=/dev/mmcblk0p3 rootfstype=ext4 rootwait; ext4load mmc 0:3 ${fit_addr} /boot/fitImage; bootm ${fit_addr} - ${fdt_addr}"
