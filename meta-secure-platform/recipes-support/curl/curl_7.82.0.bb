...
PACKAGECONFIG ??= "${@bb.utils.filter('DISTRO_FEATURES', 'ipv6', d)} libidn proxy random threaded-resolver verbose zlib"
...
PACKAGECONFIG[rustls] = "--with-rustls=${STAGING_DIR_TARGET},--without-rustls,rustls"
